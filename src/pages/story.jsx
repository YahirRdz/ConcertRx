...
const story = () => {
    return (
        <div className="w-full h-full">
            <NavBar />
            <div className="flex flex-col lg:gap-[120px] justify-center items-center md:px-[26px] lg:px-[80px]">
                <div className="flex flex-col items-center justify-center gap-8 md:mt-[118px] lg:mt-[188px] lg:w-[842px]">
                ...
                <div className="flex flex-col items-end gap-[45px]">
                    <div className="flex flex-col w-full lg:h-[267px]">
                        <div className="flex items-start md:gap-[56px] lg:gap-[141px]">
                            <h2 className="text-4xl font-bold w-[296px] text-start leading-[43px] tracking-[-0.01rem]">
                                Problem we <br></br>faced
                            </h2>
                            <div className="flex flex-col items-start md:gap-4 lg:gap-6">
                                <p className="font-normal text-lg leading-7 text-start tracking-[-0.01rem] md:w-[426px] lg:w-[843px]">
